...
/**
 * this class should work like the inherited copy factory but copying objects on
 * remote places
 * 
 * TODO: we will possibly have to rewrite the copyAttr-Methods with casts to
 * remote objects...
 * 
 * @author weissman
 */
public class RemoteMirrorFactory extends de.jreality.scene.proxy.CopyFactory {
    ...
    public void visit(de.jreality.scene.DirectionalLight l) {
        try {
            RemoteDirectionalLight newLight = factory
                    .createRemoteDirectionalLight();
            copyAttr(l, newLight);
            created = newLight;
        } catch (RemoteException e) {
            // TODO Auto-generated catch block
    ...
    public void visit(de.jreality.scene.Transformation t) {
        try {
            RemoteTransformation newTrans = factory
                    .createRemoteTransformation();
            copyAttr(t, newTrans);
            created = newTrans;
        } catch (RemoteException e) {
            // TODO Auto-generated catch block
