...
public class CostaDemo implements ChangeListener {
  ...
  private void init() throws IOException {
    ...
    SceneGraphComponent he = Readers.read(Input.getInput("3ds/costa.3ds"));
    cmp.addChild(he);
...
//      .reflect( new double[]{1,0,0,0})
  ...
  public CostaDemo() throws IOException {
    init();
