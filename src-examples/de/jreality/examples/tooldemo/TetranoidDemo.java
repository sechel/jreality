...
public class TetranoidDemo implements ChangeListener {
  ...
  private void init() throws IOException {
    ...
    SceneGraphComponent he = Readers.read(Input.getInput("3ds/tetranoid.3ds"));
    cmp.addChild(he);
    he.setAppearance(new Appearance());
    Texture2D tex = TextureUtility.createTexture(he.getAppearance(), "polygonShader", img, false);
    tex.setTextureMatrix(MatrixBuilder.euclidean().scale(15, 2, 0).getMatrix());
...
//      .assignTo(cmp);
  ...
  public TetranoidDemo() throws IOException {
    init();
    content = new ToolDemoContent(cmp, new Rectangle3D(new double[][]{{-30,0, -30},{30,50,30}}));
...
//    cm.setBlendColor(new java.awt.Color(1.0f, 0.0f, 0.0f, .3f));
  ...
  public static void main(String[] args) throws IOException {
    ...
    TetranoidDemo he2 = new TetranoidDemo();
