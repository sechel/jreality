/**
 * Added this file to have handy access to command line options.
 * 
 * see http://jargs.sourceforge.net
 * 
 * File is released under BSD-License, that sould be ok for us, right?
 * 
 * Steffen.
 * 
 * 
...
public class CmdLineParser {
    ...
    public static abstract class Option {
        ...
        protected Option( String longForm, boolean wantsValue , String exampleValue) {
            this(null, longForm, wantsValue, exampleValue);
        }

        protected Option( char shortForm, String longForm,
                          boolean wantsValue, String exampleValue) {
            this(new String(new char[]{shortForm}), longForm, wantsValue, exampleValue);
        }

        private Option( String shortForm, String longForm, boolean wantsValue , String exampleValue) {
            if ( longForm == null )
        ...
        public String toString() {
            return ((shortForm!=null)? "-"+shortForm+"," : "") +"--"+longForm;
        }
        ...
        public static class IntegerOption extends Option {
            public IntegerOption( char shortForm, String longForm ) {
                super(shortForm, longForm, true, "<int>");
            }
            public IntegerOption( String longForm ) {
                super(longForm, true, "<int>");
            }
            protected Object parseValue( String arg, Locale locale )
                throws IllegalOptionValueException {
                try {
        ...
        public static class LongOption extends Option {
            public LongOption( char shortForm, String longForm ) {
                super(shortForm, longForm, true, "<long>");
            }
            public LongOption( String longForm ) {
                super(longForm, true, "<long>");
            }
            protected Object parseValue( String arg, Locale locale )
                throws IllegalOptionValueException {
                try {
        ...
        public static class DoubleOption extends Option {
            public DoubleOption( char shortForm, String longForm ) {
                super(shortForm, longForm, true, "<double>");
            }
            public DoubleOption( String longForm ) {
                super(longForm, true, "<double>");
            }
            protected Object parseValue( String arg, Locale locale )
                throws IllegalOptionValueException {
                try {
        ...
        public static class StringOption extends Option {
            public StringOption( char shortForm, String longForm ) {
                super(shortForm, longForm, true, "<string>");
            }
            public StringOption( String longForm ) {
                super(longForm, true, "<string>");
            }
            protected Object parseValue( String arg, Locale locale ) {
                return arg;
            }
    ...
    public final Option addBooleanOption( char shortForm, String longForm ) {
        values.put(longForm, Boolean.FALSE);
    ...
    public final void parse( String[] argv, Locale locale )
        ...
        while ( position < argv.length ) {
            ...
            if ( curArg.startsWith("-") ) {
                ...
                System.out.println("putting value: "+opt.longForm()+", "+value);
                position += 1;
            }
            else {
                break;
    ...
    public void addDescription(String longForm, String description) {
        Option o = (Option) options.get("--"+longForm);
        if (o == null) throw new IllegalStateException("no such option!");
        descriptions.put(o, description);
    }
    
    public String descriptionString() {
        String descr = "";
        for (Iterator i = descriptions.keySet().iterator(); i.hasNext(); ) {
            Option o = (Option) i.next();
            descr += "\t"+o+"\t"+descriptions.get(o)+"\n";
        }
        return descr;
    }    
    ...
    public String usageString() {
        ...
        for (Iterator i = descriptions.keySet().iterator(); i.hasNext(); ) {
            Option o = (Option) i.next();
            ret += "["+(o.shortForm != null ? "{" : "")+o+(o.shortForm != null ? "}" : "")+
            (o.wantsValue() ? " "+o.exampleValue : "")+"] ";
        }
        return ret;
    }
    ...
    // added automated print-usage support
    private Hashtable descriptions = new Hashtable(10);
}
