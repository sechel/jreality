 ...
 *
 */
public class RmcPortalRemoteViewer extends RmcRemoteViewer {
...
//		}
	...
	public void render() {
		viewer.render();
		if (debug) System.out.println("["+Thread.currentThread().getName()+"] render!");
	}
	
	public void swapBuffers() {
		viewer.swapBuffers();
		if (debug) System.out.println("["+Thread.currentThread().getName()+"] swapBuffers!");
	}


	public void waitForRenderFinish() {
		if (debug) System.out.println("["+Thread.currentThread().getName()+"] waitForRenderFinish [start]");
		viewer.waitForRenderFinish();
		if (debug) System.out.println("["+Thread.currentThread().getName()+"] waitForRenderFinish [end]");
	}
	...
	public void setRemoteSceneRoot(int id) {
		...
		if (id != -1) { 
			root = (SceneGraphComponent)RmcMirrorFactoryClient.getLocal(id);
			viewer.getSceneRoot().addChild(root);
		}
		else root = null;
		System.out.println("["+Thread.currentThread().getName()+"] setted scene root: "+id);
	}
	...
	public void sendHeadTransformation(double[] tm) {
		if (debug) System.out.println("["+Thread.currentThread().getName()+"] sendHeadTransformation!");
		t.setMatrix(tm);
	...
	public static void main(String args[]) {
		...
		RmcPortalRemoteViewer obj = new RmcPortalRemoteViewer();
	}
	
	public void setBackgroundColor(java.awt.Color color) {
		viewer.setBackgroundColor(color);
		if (debug) System.out.println("set bg color: "+color);
	}
