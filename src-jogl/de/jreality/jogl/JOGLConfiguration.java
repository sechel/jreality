...
public class JOGLConfiguration {
	...
	final public static Logger theLog;
	...
	static String resourceDir = System.getProperty("home.dir"), saveResourceDir = System.getProperty("home.dir");
	static {
...
//			firstOne = GLDrawableFactory.getFactory().createGLCanvas(capabilities, null, null);	
	 ...
	 * 
	 */
	static JOGLConfiguration sharedInstance = null;
	private JOGLConfiguration() { super(); }
