...
public class LabelShader {
	...
	public static void render(LabelRenderData labelData, Label[] labels, JOGLRenderState state){
		...
		Texture2DLoader.load(gl, labelData.tex, gl.GL_TEXTURE2);
		...
		gl.glUniform4fv(gl.glGetUniformLocation(shader.shaderprogram, "xyAlignmentTotalWH"), 1, labelData.xyAlignmentTotalWH, 0);
