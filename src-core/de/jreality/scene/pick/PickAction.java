 ...
 * (each an instance of {@link de.jreality.scene.pick.PickPoint}. The caller needs to cast this
 ...
 *  		(so always "showFaces" attribute is true.)
  * @see {@link de.jreality.scene.pick.PickPoint}
...
public class PickAction extends SceneGraphVisitor{
	...
	public void setPickSegment(double[] p0, double[] p1)	{
		...
		Graphics3D cg = new Graphics3D(worldToNDC.cameraPath, null);
...
//		System.out.println("Image of p1 is: "+Rn.toString(p14NDC));
	...
	public Object visit() {
		...
		context3D  = new Graphics3D( cameraPath, null);
		pickHits.clear();
		tstackPtr = 0;
		Rn.setIdentityMatrix(tstack[0]);
