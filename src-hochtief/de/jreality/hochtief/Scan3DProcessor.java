...
//		Scan3DShowUtility.showGenerateTriangulation(100, depthThreshold, splittedFaceSize, splittedFaceId, depth, null, loader.getPhiOffset(),edgePointsNode);		
		...
		SceneGraphComponent simplifiedPointCloud=PointCloudSimplifier.getSimplifiedPointCloud(0.01, edgeId, depth, loader.getColorR(), loader.getColorG(), loader.getColorB());
